...
<html>
	...
	<br>	
		<div id="projectform">
			<form action = "project-page.php" method="get">
			<fieldset>
				<legend>Create a New Project</legend>
			<h2>Title:</h2>
				<input type="text" name="ptitle" class="textfield" size="50" placeholder="My Project Title"/>
			<br>
			<h2>Description:</h2>
				<textarea name="pdescriptioni" rows="6" cols="80" placeholder="Enter a simple description of what your project is about. Include details such as expected workloads and timelines, and (if applicable) methods of payment or compensation."></textarea>
			<br>
			<h2>Project Due Date:</h2>
				<input type="date" name="pduedate" class="date" size="50" placeholder="YYYY-MM-DD"/>
			<br><br>
