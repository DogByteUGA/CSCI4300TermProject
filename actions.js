...
function nameFix() {
    var str = document.getElementById("nameA");
    str = str.value;
   if(str != "")
     {
     	document.getElementById("name").setAttribute("class", "form-group has-success has-feedback");
	   return true;       
	 }
   else
     {
	   document.getElementById("name").setAttribute("class", "form-group has-error has-feedback");
